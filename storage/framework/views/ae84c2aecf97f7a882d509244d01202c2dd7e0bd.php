...
window.onload = function() {
  ...
  const ui = SwaggerUIBundle({
    ...
    url: "<?php echo e(url('/')); ?>/docs/api-docs.json",
    ...
    persistAuthorization: <?php echo config('l5-swagger.defaults.persist_authorization') ? 'true' : 'false'; ?>,
  })
...
<?php /**PATH /gmd/resources/views/docs.blade.php ENDPATH**/ ?>